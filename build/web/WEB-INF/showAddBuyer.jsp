...
<html>
    ...
    <body>
        <h1>WEB-SHOP</h1>
            ...
            <form class="form-horizontal" action="addNewBuyer" method="POST">
<fieldset>
...
<!-- Text input-->
<div class="control-group">
  <label class="control-label" for="textinput">Баланс</label>
  <div class="controls">
    <input name="cash" type="number" placeholder="" class="input-xlarge">
